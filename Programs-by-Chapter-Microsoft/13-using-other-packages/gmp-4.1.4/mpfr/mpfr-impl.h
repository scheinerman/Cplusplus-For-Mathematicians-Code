...
/* NAN=-1.#IND00e+000 PINF=1.#INF00e+000 NINF=-1.#INF00e+000 */
...
#define DBL_POS_INF ( 1.0 / double_zero)
#define DBL_NEG_INF (-1.0 / double_zero)
#define DBL_NAN     ( 0.0 / double_zero)
